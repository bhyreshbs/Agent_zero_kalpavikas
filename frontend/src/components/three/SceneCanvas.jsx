...
export default function SceneCanvas({ tone = 'cyan', flashColor = null, children, height = '100%' }) {
  const color = toneColor(tone);
  const ambientColor = flashColor || color;
  const containerHeight = typeof height === 'number' ? `${height}px` : height;

  return (
    <div className="az-scene3d-wrap" style={{ height: containerHeight, width: '100%', position: 'relative' }}>
      <Canvas
        shadows={false}
        dpr={[1, 1.5]}
